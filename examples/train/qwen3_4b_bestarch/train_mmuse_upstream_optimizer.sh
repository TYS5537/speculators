#!/bin/bash
# MMuse bestarch: upstream Muon/AdamW parameter grouping and full attention.
...
OUTPUT_DIR="./output/qwen3_4b_bestarch/mmuse_upstream_optimizer"
RUN_NAME="mmuse_upstream_optimizer"
VLLM_PORT=8001
...
MUON_PARAMETER_POLICY="upstream"
BLOCK_SIZE=7
MAX_ANCHORS=512
NUM_LAYERS=5
