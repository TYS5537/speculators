...
def test_reconcile_validates_candidate_before_inheritance_overrides_and_caller_log(
    ...
    monkeypatch.setattr(model_config, "validate_muse_options", validator)
    logger = Mock()
...
@pytest.mark.parametrize(
    ...
    [
        ("checkpoint", None, "muse", set(), None),
        (None, "decoder", "muse", set(), None),
        (None, None, "muse", {"draft_arch", "num_layers"}, None),
        ...
        (None, "decoder", "muse", {"draft_arch", "num_layers"}, "--draft-config"),
