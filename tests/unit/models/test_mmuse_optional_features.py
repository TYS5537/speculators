"""Tests for MMuse backbone features and baseline parity."""
...
def _make_model(*, num_draft_layers: int = 1, **feature_flags) -> MMuseDraftModel:
    ...
    return MMuseDraftModel(config).eval()
