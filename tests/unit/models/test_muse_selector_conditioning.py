...
class _ConditioningHarness(nn.Module):
    _prepare_selector_conditioning = MuseDraftModel._prepare_selector_conditioning
    ...
    _prepend_zero_compact_feature = staticmethod(
        MuseDraftModel._prepend_zero_compact_feature
    )
    ...
    def _selector_correction_inputs(self, *args, **kwargs):
        result = MuseDraftModel._selector_correction_inputs(self, *args, **kwargs)
