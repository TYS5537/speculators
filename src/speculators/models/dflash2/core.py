...
from speculators.losses import LossConfig, kl_div_loss, tv_loss
...
from speculators.models.metrics import resolve_training_loss
...
class DFlash2DraftModel(DFlashDraftModel):
    ...
    def get_trainer_kwargs(**kwargs) -> tuple[dict, dict]:
        ...
        tv_loss_fn = resolve_training_loss(**{**kwargs, "loss_fn": "tv"})["tv"][0]
        shared = {
    ...
    def forward(
        ...
        **kwargs,
        ...
        if unary_logits is None:
            raise RuntimeError("DFlash2 requires projected draft logits")
